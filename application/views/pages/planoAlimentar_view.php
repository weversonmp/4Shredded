...
<body>
	<header class="navbar-dark-gray" style="width: 4.5rem;" id="idheader">
		<nav class="d-flex flex-column text-center my-4 justify-content-between">
	...
	<main>
		<div id="full-content" class="vw-100 vh-100 d-flex justify-content-between">
								...
								<dialog id="dialogteste">
									<div class="dialog-in d-flex flex-column justify-content-between h-100">
										...
										<div class="w-100 d-flex justify-content-center gap-2">
											<button class="btn btn-outline-primary  ">+ Add Alimento</button>
			...
			<div class="navbar-dark-gray" id="idRelatorio">
				<div class="">
					<h3>Relatório</h3>
				</div>
			</div>
